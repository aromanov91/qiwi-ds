...
function (_React$Component) {
  ...
  function RadialGradient() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(RadialGradient).apply(this, arguments));
  }
  ...
  _createClass(RadialGradient, [{
    ...
    value: function render() {
      ...
      return React.createElement("svg_radialGradient", rest, children);
    }
  }]);
...
_defineProperty(RadialGradient, "propTypes", {
...
_defineProperty(RadialGradient, "defaultProps", {
  fx: '50%',
  fy: '50%',
  cx: '50%',
  cy: '50%',
