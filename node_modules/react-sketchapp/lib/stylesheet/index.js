...
var extractRules = function extractRules(style) {
  ...
  Object.keys(style).forEach(function (key) {
    if (key[0] === ':') {// pseudo style. ignore for now.
    } else if (key[0] === '@') {// Media query. ignore for now.
    } else {
...
var registerStyle = function registerStyle(style) {
  ...
  declarationRegistry[id] = (0, _expandStyle.default)(rules.declarations);
  return id;
};
...
var flattenStyle = function flattenStyle(input) {
  ...
  return (0, _expandStyle.default)(input);
};
/**
...
var _default = {
  hairlineWidth: 1,
  // TODO(lmr): should this be something different?
