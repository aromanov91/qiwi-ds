...
exports.makeImageDataFromUrl = exports.TEXT_TRANSFORM = exports.TEXT_DECORATION_LINETHROUGH = exports.TEXT_DECORATION_UNDERLINE = exports.TEXT_ALIGN = void 0;
...
var makeImageDataFromUrl = function makeImageDataFromUrl(url) {
...
exports.makeImageDataFromUrl = makeImageDataFromUrl;
...
function makeResizeConstraint(resizingConstraint) {
  if (resizingConstraint) {
    ...
    if (constraints.length > 0) {
      ...
      if (!constraint) {
        throw new Error("\n".concat(JSON.stringify(resizingConstraint, null, 2), "\nconstraint is not a valid combination."));
      }
...
function createStringAttributes(textStyles) {
  var font = (0, _findFont.default)(textStyles);
  var textDecoration = textStyles.textDecoration;
  var underline = textDecoration && TEXT_DECORATION_UNDERLINE[textDecoration];
  var strikethrough = textDecoration && TEXT_DECORATION_LINETHROUGH[textDecoration];
  var attribs = {
  ...
  if ((0, _getSketchVersion.default)() >= 50) {
...
function makeTextStyle(textStyle) {
  ...
  var font = (0, _findFont.default)(textStyle);
