...
var findFont = function findFont(style) {
  ...
  var familyName = defaultFontFamily == _constants.APPLE_BROKEN_SYSTEM_FONT ? 'Helvetica' : defaultFontFamily;
  var isItalic = false;
  ...
  if (!didFindFont && fontNames.length === 0) {
    ...
    if (font) {
      ...
      log("Unrecognized font family '".concat(familyName, "'"));
      font = NSFont.systemFontOfSize_weight(fontSize, fontWeight);
    }
